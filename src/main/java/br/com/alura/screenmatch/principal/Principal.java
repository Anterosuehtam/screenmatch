...
public class Principal {
    ...
    public void exibeMenu() {
        ...
        while (opcao != 0) {
            var menu = """
                    ...
                    10 - Top 5 episódios de determinada série
    ...
    private void buscarSeriePorQtdeTemporadas() {
        System.out.println("Qual a quantidade máxima de temporadas a série que está buscando deve conter?");
    ...
    private void buscarEpisodioPorTrecho() {
        ...
        List<Episodio> epsEncontrados = serieRepository.episodiosPortrecho(trechoEpisodio);
    ...
    private void topEpisodiosPorSerie() {
        ...
        if (serieBusca.isPresent()){
            ...
            topEpisodios.forEach(e ->  System.out.printf("Série: %s | Temporada: %s - Episódio %s | Nome: %s | Avaliação: %s \n",
                    e.getSerie().getTitulo(),
                    e.getTemporada(),
                    e.getNumeroEpisodio(),
                    e.getTitulo(),
